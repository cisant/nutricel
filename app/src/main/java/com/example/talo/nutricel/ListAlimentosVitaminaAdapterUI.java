...
public class ListAlimentosVitaminaAdapterUI extends ArrayAdapter<AlimentosVitamina> {

    private Context context;
    private List<AlimentosVitamina> alimentos = null;

    public ListAlimentosVitaminaAdapterUI(Context context, List<AlimentosVitamina> alimentos) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        String textoQuantidade = "Quantidade: " + String.valueOf(ali.getQuantidade()) + " UI";
